...
//	public static final int TOKEN_QUOTED_ID = 2;
	...
	public static final int TOKEN_WHITESPACE = 6;
	...
	private static final int STATE_NUMBER = TOKEN_NUMBER;
	...
	public void setKeywords(String[] keywords) {
		keywordHashtable = new Hashtable<String, Boolean>(keywords.length);
	...
	public boolean nextToken() {
		...
		for (;;) {
			...
			case STATE_WORD:
				if (lookahead >= 'A' && lookahead <= 'Z' || 
						lookahead >= 'a' && lookahead <= 'z' 
//							|| lookahead >= '0'	&& lookahead <= '9' -> USE TOKEN_NUMBER
